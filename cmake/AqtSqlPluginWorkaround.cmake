...
function(sonarp_remove_missing_qt_sql_driver_cmake)
    ...
    # Plugin basename: Windows qsqlite.dll; Unix/macOS libqsqlite.so / .dylib
    if(WIN32)
        set(_plugin_prefix "")
        set(_plugin_ext ".dll")
    elseif(APPLE)
        set(_plugin_prefix "lib")
        set(_plugin_ext ".dylib")
    else()
        set(_plugin_prefix "lib")
        set(_plugin_ext ".so")
    endif()
    ...
    foreach(_prefix IN LISTS _prefix_candidates)
        ...
        set(_sqlite_plugin "${_drivers_dir}/${_plugin_prefix}qsqlite${_plugin_ext}")
        set(_mysql_plugin "${_drivers_dir}/${_plugin_prefix}qsqlmysql${_plugin_ext}")
